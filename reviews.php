...
if (isset($_GET['page_id'])) {
    if (isset($_POST['name'], $_POST['rating'], $_POST['content'])) {
        ...
        $stmt = $pdo->prepare('INSERT INTO reviews (page_id, name, content, rating, submit_date, created_at) VALUES (?,?,?,?,NOW(),now())');
...
<div class="overall_rating">
    <span class="num1"><?=number_format($reviews_info['overall_rating'], 1)?></span>
...
<div class="write_review">
    <form>
        ...
        <button class="sub" type="submit">Submit Review</button>
    </form>
</div>
...
<div class="review">
    ...
    <p class="content_rating"><?=htmlspecialchars($review['content'], ENT_QUOTES)?></p>
</div>
<?php endforeach ?>
</body>
</html>